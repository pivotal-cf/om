...
func (fake *AwsRunner) ExecuteWithEnvVars(arg1 []string, arg2 []interface{}) (*bytes.Buffer, *bytes.Buffer, error) {
	var arg1Copy []string
	if arg1 != nil {
...
func (fake *AwsRunner) ExecuteWithEnvVarsCallCount() int {
...
func (fake *AwsRunner) ExecuteWithEnvVarsCalls(stub func([]string, []interface{}) (*bytes.Buffer, *bytes.Buffer, error)) {
	fake.executeWithEnvVarsMutex.Lock()
	defer fake.executeWithEnvVarsMutex.Unlock()
	fake.ExecuteWithEnvVarsStub = stub
}

func (fake *AwsRunner) ExecuteWithEnvVarsArgsForCall(i int) ([]string, []interface{}) {
	fake.executeWithEnvVarsMutex.RLock()
	defer fake.executeWithEnvVarsMutex.RUnlock()
...
func (fake *AwsRunner) ExecuteWithEnvVarsReturns(result1 *bytes.Buffer, result2 *bytes.Buffer, result3 error) {
	fake.executeWithEnvVarsMutex.Lock()
	defer fake.executeWithEnvVarsMutex.Unlock()
...
func (fake *AwsRunner) ExecuteWithEnvVarsReturnsOnCall(i int, result1 *bytes.Buffer, result2 *bytes.Buffer, result3 error) {
	fake.executeWithEnvVarsMutex.Lock()
	defer fake.executeWithEnvVarsMutex.Unlock()
	fake.ExecuteWithEnvVarsStub = nil
...
func (fake *AwsRunner) Invocations() map[string][][]interface{} {
...
func (fake *AwsRunner) recordInvocation(key string, args []interface{}) {
