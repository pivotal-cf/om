...
type ReleasesService struct {
	FromDirectoriesStub        func(directories []string) (releases map[string]interface{}, err error)
...
func (fake *ReleasesService) FromDirectories(directories []string) (releases map[string]interface{}, err error) {
...
func (fake *ReleasesService) FromDirectoriesCallCount() int {
	fake.fromDirectoriesMutex.RLock()
	defer fake.fromDirectoriesMutex.RUnlock()
	return len(fake.fromDirectoriesArgsForCall)
}

func (fake *ReleasesService) FromDirectoriesArgsForCall(i int) []string {
	fake.fromDirectoriesMutex.RLock()
	defer fake.fromDirectoriesMutex.RUnlock()
	return fake.fromDirectoriesArgsForCall[i].directories
}

func (fake *ReleasesService) FromDirectoriesReturns(result1 map[string]interface{}, result2 error) {
...
func (fake *ReleasesService) FromDirectoriesReturnsOnCall(i int, result1 map[string]interface{}, result2 error) {
	fake.FromDirectoriesStub = nil
...
func (fake *ReleasesService) Invocations() map[string][][]interface{} {
...
func (fake *ReleasesService) recordInvocation(key string, args []interface{}) {
