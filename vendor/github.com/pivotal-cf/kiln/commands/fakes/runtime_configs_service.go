...
type RuntimeConfigsService struct {
	FromDirectoriesStub        func(directories []string) (runtimeConfigs map[string]interface{}, err error)
...
func (fake *RuntimeConfigsService) FromDirectories(directories []string) (runtimeConfigs map[string]interface{}, err error) {
