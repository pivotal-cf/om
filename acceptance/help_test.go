...
Usage: om [options] <command> [<args>]
  ...
  --vars-env                                             string (variadic)  use with --env to interpolate shell environment variables into env config file
  --vars-file                                            string (variadic)  use with --env to interpolate variables from vars-file into env config file
