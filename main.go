...
func main() {
	...
	credentialReferencesService := api.NewCredentialReferencesService(authedClient, progress.NewBar(), liveWriter)
	credentialsService := api.NewCredentialsService(authedClient, progress.NewBar(), liveWriter)
