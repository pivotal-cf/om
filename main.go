...
func main() {
	...
	installationAssetsService := api.NewInstallationAssetsService(authedClient, progress.NewBar())
	...
	commandSet["export-installation"] = commands.NewExportInstallation(installationAssetsService, logger)
