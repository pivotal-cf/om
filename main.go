...
type options struct {
	...
	VarsFiles            []string `                                        long:"vars-file"                                                        description:"use with --env to interpolate variables from vars-file into env config file"`
	VarsEnvs             []string `                                        long:"vars-env"                                                         description:"use with --env to interpolate shell environment variables into env config file"`
