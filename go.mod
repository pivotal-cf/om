...
require (
	...
	github.com/cloudfoundry/bosh-utils v0.0.0-20200229100151-19776694af99 // indirect
	...
	github.com/pivotal-cf/go-pivnet/v4 v4.0.2
	github.com/pivotal-cf/jhanda v0.0.0-20191113141013-9cb1997202c0
	github.com/pivotal-cf/pivnet-cli v1.0.1
