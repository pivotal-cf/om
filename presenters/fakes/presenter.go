...
type Presenter struct {
	...
	PresentCredentialsStub        func(interface{})
...
func (fake *Presenter) PresentCredentials(arg1 interface{}) {
...
func (fake *Presenter) PresentCredentialsCalls(stub func(interface{})) {
	fake.presentCredentialsMutex.Lock()
	defer fake.presentCredentialsMutex.Unlock()
	fake.PresentCredentialsStub = stub
}

func (fake *Presenter) PresentCredentialsArgsForCall(i int) interface{} {
	fake.presentCredentialsMutex.RLock()
	defer fake.presentCredentialsMutex.RUnlock()
...
func (fake *Presenter) PresentPendingChangesCalls(stub func(api.PendingChangesOutput)) {
	fake.presentPendingChangesMutex.Lock()
	defer fake.presentPendingChangesMutex.Unlock()
	fake.PresentPendingChangesStub = stub
}

func (fake *Presenter) PresentPendingChangesArgsForCall(i int) api.PendingChangesOutput {
	fake.presentPendingChangesMutex.RLock()
	defer fake.presentPendingChangesMutex.RUnlock()
...
func (fake *Presenter) PresentSSLCertificateCallCount() int {
...
func (fake *Presenter) PresentSSLCertificateCalls(stub func(api.SSLCertificate)) {
	fake.presentSSLCertificateMutex.Lock()
	defer fake.presentSSLCertificateMutex.Unlock()
	fake.PresentSSLCertificateStub = stub
}

func (fake *Presenter) PresentSSLCertificateArgsForCall(i int) api.SSLCertificate {
	fake.presentSSLCertificateMutex.RLock()
	defer fake.presentSSLCertificateMutex.RUnlock()
