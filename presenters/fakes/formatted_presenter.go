...
func (fake *FormattedPresenter) PresentCredentials(arg1 interface{}) {
...
func (fake *FormattedPresenter) PresentCredentialsCalls(stub func(interface{})) {
	fake.presentCredentialsMutex.Lock()
	defer fake.presentCredentialsMutex.Unlock()
	fake.PresentCredentialsStub = stub
}

func (fake *FormattedPresenter) PresentCredentialsArgsForCall(i int) interface{} {
	fake.presentCredentialsMutex.RLock()
	defer fake.presentCredentialsMutex.RUnlock()
...
func (fake *FormattedPresenter) PresentDiagnosticReport(arg1 api.DiagnosticReport) {
...
func (fake *FormattedPresenter) PresentDiagnosticReportCallCount() int {
...
func (fake *FormattedPresenter) PresentDiagnosticReportCalls(stub func(api.DiagnosticReport)) {
	fake.presentDiagnosticReportMutex.Lock()
	defer fake.presentDiagnosticReportMutex.Unlock()
	fake.PresentDiagnosticReportStub = stub
}

func (fake *FormattedPresenter) PresentDiagnosticReportArgsForCall(i int) api.DiagnosticReport {
	fake.presentDiagnosticReportMutex.RLock()
	defer fake.presentDiagnosticReportMutex.RUnlock()
...
func (fake *FormattedPresenter) PresentLicensedProducts(arg1 []api.ExpiringLicenseOutput) {
...
func (fake *FormattedPresenter) PresentLicensedProductsCallCount() int {
...
func (fake *FormattedPresenter) PresentLicensedProductsCalls(stub func([]api.ExpiringLicenseOutput)) {
	fake.presentLicensedProductsMutex.Lock()
	defer fake.presentLicensedProductsMutex.Unlock()
	fake.PresentLicensedProductsStub = stub
}

func (fake *FormattedPresenter) PresentLicensedProductsArgsForCall(i int) []api.ExpiringLicenseOutput {
	fake.presentLicensedProductsMutex.RLock()
	defer fake.presentLicensedProductsMutex.RUnlock()
...
func (fake *FormattedPresenter) PresentProducts(arg1 models.ProductsVersionsDisplay) {
...
func (fake *FormattedPresenter) PresentProductsCalls(stub func(models.ProductsVersionsDisplay)) {
	fake.presentProductsMutex.Lock()
	defer fake.presentProductsMutex.Unlock()
	fake.PresentProductsStub = stub
}

func (fake *FormattedPresenter) PresentProductsArgsForCall(i int) models.ProductsVersionsDisplay {
	fake.presentProductsMutex.RLock()
	defer fake.presentProductsMutex.RUnlock()
