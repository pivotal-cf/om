<!--- This file is autogenerated from the files in docsgenerator/templates/installations --->
...
```
Usage:
  om [OPTIONS] installations [installations-OPTIONS]
