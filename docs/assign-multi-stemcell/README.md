<!--- This file is autogenerated from the files in docsgenerator/templates/assign-multi-stemcell --->
...
```
Usage:
  om [OPTIONS] assign-multi-stemcell [assign-multi-stemcell-OPTIONS]

This command will assign multiple already uploaded stemcells to a specific
product in Ops Manager 2.6+.
