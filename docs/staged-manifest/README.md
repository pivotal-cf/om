<!--- This file is autogenerated from the files in docsgenerator/templates/staged-manifest --->
...
```
Usage:
  om [OPTIONS] staged-manifest [staged-manifest-OPTIONS]
...
[staged-manifest command options]
