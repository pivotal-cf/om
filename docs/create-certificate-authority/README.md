<!--- This file is autogenerated from the files in docsgenerator/templates/create-certificate-authority --->
&larr; [back to Commands](../README.md)

# `om create-certificate-authority`

This authenticated command creates a certificate authority on the Ops Manager
with the given cert and key

## Command Usage
```
Usage:
  om [OPTIONS] create-certificate-authority [create-certificate-authority-OPTIONS]
...
[create-certificate-authority command options]
