<!--- This file is autogenerated from the files in docsgenerator/templates/get-certificates --->
&larr; [back to Commands](../README.md)

# `om get-certificates`

fetches all deployed certificates, retrieves their PEMs, extracts serial
numbers, and displays the merged result

## Command Usage
```
Usage:
  om [OPTIONS] get-certificates [get-certificates-OPTIONS]
...
[get-certificates command options]
      -p, --product=           product type to filter certificates (e.g.,
                               p-bosh, cf)
```
