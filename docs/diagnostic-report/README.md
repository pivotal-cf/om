<!--- This file is autogenerated from the files in docsgenerator/templates/diagnostic-report --->
&larr; [back to Commands](../README.md)

# `om diagnostic-report`

retrieve a diagnostic report with general information about the state of your
Ops Manager.

## Command Usage
```
Usage:
  om [OPTIONS] diagnostic-report
