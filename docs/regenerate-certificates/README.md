<!--- This file is autogenerated from the files in docsgenerator/templates/regenerate-certificates --->
&larr; [back to Commands](../README.md)

# `om regenerate-certificates`

This authenticated command deletes all non-configurable certificates in Ops
Manager so they will automatically be regenerated on the next apply-changes

## Command Usage
```
Usage:
  om [OPTIONS] regenerate-certificates
