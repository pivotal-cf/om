<!--- This file is autogenerated from the files in docsgenerator/templates/credential-references --->
&larr; [back to Commands](../README.md)

# `om credential-references`
...
```
Usage:
  om [OPTIONS] credential-references [credential-references-OPTIONS]
...
[credential-references command options]
