<!--- This file is autogenerated from the files in docsgenerator/templates/generate-certificate --->
&larr; [back to Commands](../README.md)

# `om generate-certificate`

This authenticated command generates a new RSA public/private certificate
signed by Ops Manager’s root CA certificate
...
[generate-certificate command options]
      -d, --domains=           domains to generate certificates, can include
                               wildcard domains. Can be delimited by comma,
                               specified in multiple flags, or both
```
