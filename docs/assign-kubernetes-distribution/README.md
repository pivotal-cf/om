<!--- This file is autogenerated from the files in docsgenerator/templates/assign-kubernetes-distribution --->
&larr; [back to Commands](../README.md)

# `om assign-kubernetes-distribution`

This command will assign a kubernetes distribution to a specific kubernetes
product in Ops Manager

## Command Usage
```
Usage:
  om [OPTIONS] assign-kubernetes-distribution [assign-kubernetes-distribution-OPTIONS]
...
[assign-kubernetes-distribution command options]
      -p, --product=           name of Ops Manager tile to associate a
                               kubernetes distribution to
      -d, --distribution=      kubernetes distribution to assign
                               (identifier:version, e.g.
                               'embedded-kubernetes:1.0.0' or
                               'embedded-kubernetes:latest')
