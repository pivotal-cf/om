<!--- This file is autogenerated from the files in docsgenerator/templates/revert-staged-changes --->
&larr; [back to Commands](../README.md)

# `om revert-staged-changes`

This command reverts the staged changes already on an Ops Manager. Useful for
ensuring that unintended changes are not applied.

## Command Usage
```
Usage:
  om [OPTIONS] revert-staged-changes
