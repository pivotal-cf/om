<!--- This file is autogenerated from the files in docsgenerator/templates/generate-certificate-authority --->
&larr; [back to Commands](../README.md)

# `om generate-certificate-authority`
...
```
Usage:
  om [OPTIONS] generate-certificate-authority [generate-certificate-authority-OPTIONS]
...
[generate-certificate-authority command options]
