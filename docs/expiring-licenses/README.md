<!--- This file is autogenerated from the files in docsgenerator/templates/expiring-licenses --->
&larr; [back to Commands](../README.md)

# `om expiring-licenses`
...
```
Usage:
  om [OPTIONS] expiring-licenses [expiring-licenses-OPTIONS]
