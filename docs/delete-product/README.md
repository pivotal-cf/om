<!--- This file is autogenerated from the files in docsgenerator/templates/delete-product --->
...
```
Usage:
  om [OPTIONS] delete-product [delete-product-OPTIONS]
...
[delete-product command options]
      -p, --product-name=      name of product
      -v, --product-version=   version of product
```
