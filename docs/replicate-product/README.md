<!--- This file is autogenerated from the files in docsgenerator/templates/replicate-product --->
&larr; [back to Commands](../README.md)

# `om replicate-product`

This command stages a product as a replica in the Ops Manager with a unique
replica-suffix.

## Command Usage
```
Usage:
  om [OPTIONS] replicate-product [replicate-product-OPTIONS]
