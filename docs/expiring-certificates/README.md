<!--- This file is autogenerated from the files in docsgenerator/templates/expiring-certificates --->
...
```
Usage:
  om [OPTIONS] expiring-certificates [expiring-certificates-OPTIONS]
...
[expiring-certificates command options]
