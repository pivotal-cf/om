<!--- This file is autogenerated from the files in docsgenerator/templates/certificate-authorities file --->
...
## Command Usage
```
ॐ  certificate-authorities
lists certificates managed by Ops Manager

Usage: om [options] certificate-authorities [<args>]
