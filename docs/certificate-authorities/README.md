<!--- This file is autogenerated from the files in docsgenerator/templates/certificate-authorities --->
...
```
Usage:
  om [OPTIONS] certificate-authorities [certificate-authorities-OPTIONS]
...
[certificate-authorities command options]
