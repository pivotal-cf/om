<!--- This file is autogenerated from the files in docsgenerator/templates/kubernetes-distributions --->
&larr; [back to Commands](../README.md)

# `om kubernetes-distributions`

This command lists all kubernetes distributions in Ops Manager, showing which
products have them staged or deployed

## Command Usage
```
Usage:
  om [OPTIONS] kubernetes-distributions [kubernetes-distributions-OPTIONS]
...
[kubernetes-distributions command options]
      -p, --product=           filter to distributions available for a specific
                               product
