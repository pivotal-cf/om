<!--- This file is autogenerated from the files in docsgenerator/templates/pre-deploy-check --->
&larr; [back to Commands](../README.md)

# `om pre-deploy-check`

This authenticated checks completeness and validity of product configuration.
This includes whether stemcells are assigned, missing configuration, and failed
validators for a product.

## Command Usage
```
Usage:
  om [OPTIONS] pre-deploy-check [pre-deploy-check-OPTIONS]
...
[pre-deploy-check command options]
