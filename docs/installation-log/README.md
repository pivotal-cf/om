<!--- This file is autogenerated from the files in docsgenerator/templates/installation-log --->
...
```
Usage:
  om [OPTIONS] installation-log [installation-log-OPTIONS]
...
[installation-log command options]
          --id=                id of the installation to retrieve logs for
```
