...
**DEPRECATED** This authenticated command lists all staged products. Use
'products --staged' instead.

## Command Usage
```
Usage:
  om [OPTIONS] staged-products [staged-products-OPTIONS]
...
[staged-products command options]
