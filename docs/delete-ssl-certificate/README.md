<!--- This file is autogenerated from the files in docsgenerator/templates/delete-ssl-certificate --->
&larr; [back to Commands](../README.md)

# `om delete-ssl-certificate`

This authenticated command deletes a custom certificate applied to Ops Manager
and reverts to the auto-generated cert
