<!--- This file is autogenerated from the files in docsgenerator/templates/available-products --->
...
```
Usage:
  om [OPTIONS] available-products [available-products-OPTIONS]

**DEPRECATED** This authenticated command lists all available products. Use
'products --available' instead.
...
[available-products command options]
