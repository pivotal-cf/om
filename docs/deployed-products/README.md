<!--- This file is autogenerated from the files in docsgenerator/templates/deployed-products --->
&larr; [back to Commands](../README.md)

# `om deployed-products`

**DEPRECATED** This authenticated command lists all deployed products. Use
'products --deployed' instead.

## Command Usage
```
Usage:
  om [OPTIONS] deployed-products [deployed-products-OPTIONS]
...
[deployed-products command options]
