<!--- This file is autogenerated from the files in docsgenerator/templates/deployed-manifest --->
...
```
Usage:
  om [OPTIONS] deployed-manifest [deployed-manifest-OPTIONS]
...
[deployed-manifest command options]
