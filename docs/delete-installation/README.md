<!--- This file is autogenerated from the files in docsgenerator/templates/delete-installation file --->
...
Usage: om [options] delete-installation [<args>]
...
Command Arguments:
  --force, -f  bool  used to avoid interactive prompt acknowledging deletion
