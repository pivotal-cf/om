<!--- This file is autogenerated from the files in docsgenerator/templates/delete-installation --->
...
```
Usage:
  om [OPTIONS] delete-installation [delete-installation-OPTIONS]

This authenticated command deletes all the products installed on the targeted
Ops Manager.
...
[delete-installation command options]
      -f, --force              used to avoid interactive prompt acknowledging
                               deletion
```
