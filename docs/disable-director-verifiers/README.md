<!--- This file is autogenerated from the files in docsgenerator/templates/disable-director-verifiers --->
&larr; [back to Commands](../README.md)

# `om disable-director-verifiers`
...
```
Usage:
  om [OPTIONS] disable-director-verifiers [disable-director-verifiers-OPTIONS]
