...
func (u Ui) GetForm(path string) (Form, error) {
...
func (u Ui) PostForm(input PostFormInput) error {
...
func (u Ui) AvailabilityZones() (map[string]string, error) {
...
func (u Ui) Networks() (map[string]string, error) {
