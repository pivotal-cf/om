...
func (fake *DeleteUnusedProductsService) Invocations() map[string][][]interface{} {
...
func (fake *DeleteUnusedProductsService) recordInvocation(key string, args []interface{}) {
