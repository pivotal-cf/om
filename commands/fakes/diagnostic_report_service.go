...
func (fake *DiagnosticReportService) GetDiagnosticReport() (api.DiagnosticReport, error) {
...
func (fake *DiagnosticReportService) GetDiagnosticReportCallCount() int {
...
func (fake *DiagnosticReportService) GetDiagnosticReportCalls(stub func() (api.DiagnosticReport, error)) {
	fake.getDiagnosticReportMutex.Lock()
	defer fake.getDiagnosticReportMutex.Unlock()
	fake.GetDiagnosticReportStub = stub
}

func (fake *DiagnosticReportService) GetDiagnosticReportReturns(result1 api.DiagnosticReport, result2 error) {
	fake.getDiagnosticReportMutex.Lock()
	defer fake.getDiagnosticReportMutex.Unlock()
...
func (fake *DiagnosticReportService) GetDiagnosticReportReturnsOnCall(i int, result1 api.DiagnosticReport, result2 error) {
	fake.getDiagnosticReportMutex.Lock()
	defer fake.getDiagnosticReportMutex.Unlock()
	fake.GetDiagnosticReportStub = nil
...
func (fake *DiagnosticReportService) Invocations() map[string][][]interface{} {
...
func (fake *DiagnosticReportService) recordInvocation(key string, args []interface{}) {
