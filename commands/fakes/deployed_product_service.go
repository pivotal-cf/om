...
func (fake *DeployedProductService) ListDeployedProducts() ([]api.DeployedProductOutput, error) {
...
func (fake *DeployedProductService) ListDeployedProductsCallCount() int {
...
func (fake *DeployedProductService) ListDeployedProductsReturns(result1 []api.DeployedProductOutput, result2 error) {
...
func (fake *DeployedProductService) ListDeployedProductsReturnsOnCall(i int, result1 []api.DeployedProductOutput, result2 error) {
	fake.ListDeployedProductsStub = nil
...
func (fake *DeployedProductService) GetDeployedProductManifest(guid string) (string, error) {
...
func (fake *DeployedProductService) GetDeployedProductManifestCallCount() int {
...
func (fake *DeployedProductService) GetDeployedProductManifestArgsForCall(i int) string {
	fake.getDeployedProductManifestMutex.RLock()
	defer fake.getDeployedProductManifestMutex.RUnlock()
	return fake.getDeployedProductManifestArgsForCall[i].guid
}

func (fake *DeployedProductService) GetDeployedProductManifestReturns(result1 string, result2 error) {
...
func (fake *DeployedProductService) GetDeployedProductManifestReturnsOnCall(i int, result1 string, result2 error) {
	fake.GetDeployedProductManifestStub = nil
...
func (fake *DeployedProductService) Invocations() map[string][][]interface{} {
...
func (fake *DeployedProductService) recordInvocation(key string, args []interface{}) {
