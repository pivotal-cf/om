...
func (fake *CertificateRegenerator) RegenerateCertificates() error {
...
func (fake *CertificateRegenerator) RegenerateCertificatesCallCount() int {
...
func (fake *CertificateRegenerator) RegenerateCertificatesReturns(result1 error) {
...
func (fake *CertificateRegenerator) RegenerateCertificatesReturnsOnCall(i int, result1 error) {
	fake.RegenerateCertificatesStub = nil
