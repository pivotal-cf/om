...
func (fake *ExpiringLicensesService) ListExpiringLicenses(arg1 string) ([]api.ExpiringLicense, error) {
...
func (fake *ExpiringLicensesService) ListExpiringLicensesCalls(stub func(string) ([]api.ExpiringLicense, error)) {
	fake.listExpiringLicensesMutex.Lock()
...
func (fake *ExpiringLicensesService) ListExpiringLicensesReturns(result1 []api.ExpiringLicense, result2 error) {
	fake.listExpiringLicensesMutex.Lock()
	defer fake.listExpiringLicensesMutex.Unlock()
...
func (fake *ExpiringLicensesService) ListExpiringLicensesReturnsOnCall(i int, result1 []api.ExpiringLicense, result2 error) {
	fake.listExpiringLicensesMutex.Lock()
	defer fake.listExpiringLicensesMutex.Unlock()
	fake.ListExpiringLicensesStub = nil
